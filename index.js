class CodeDisplay extends HTMLElement {
  constructor () {
    ...
    this._textarea = this.firstElementChild
    ...
    this._loadScriptsAndDisplay = function (self) {
      ...
      el.onload = function (e) {
        ...
        if (self._scripts.length) {
          ...
          self._appendStyles(self)
          self._removeLoadingImage(self)
          self._display(self)
        }
      }
      el.src = script
    ...
    this._onMouseEnter = function (e) {
      e.target.querySelector('div[id="clipboard"]').style.display = 'block'
    }
    this._onMouseLeave = function (e) {
      const clipboard = e.target.querySelector('div[id="clipboard"]')
    ...
    this._onChange = function () {
      // this = CodeDisplay object
      this.shadowRoot.querySelector('pre').remove()
      this._code = this._textarea.value
      this._display(this)
    }
    ...
    // Adding event listener for changes on input textarea
