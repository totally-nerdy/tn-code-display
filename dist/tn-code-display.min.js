class CodeDisplay extends HTMLElement{constructor(){super();const s='<svg fill="#000" width="24" height="24" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M9.5 0a.5.5 0 0 1 .5.5.5.5 0 0 0 .5.5.5.5 0 0 1 .5.5V2a.5.5 0 0 1-.5.5h-5A.5.5 0 0 1 5 2v-.5a.5.5 0 0 1 .5-.5.5.5 0 0 0 .5-.5.5.5 0 0 1 .5-.5z"/><path d="M3.5 1h.585A1.5 1.5 0 0 0 4 1.5V2a1.5 1.5 0 0 0 1.5 1.5h5A1.5 1.5 0 0 0 12 2v-.5q-.001-.264-.085-.5h.585A1.5 1.5 0 0 1 14 2.5v12a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 14.5v-12A1.5 1.5 0 0 1 3.5 1"/></svg>';switch(this._code=this.firstElementChild.value,this._prettyCode="",this._language=this.getAttribute("data-language"),this._style=this.getAttribute("data-style")||"monokai-sublime",this._loadingColor=this.getAttribute("data-loading-color")||"#10c100",this._clipboard=Boolean(this.getAttribute("data-clipboard")||!1),this._scripts=["https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.7.0/highlight.min.js","https://www.unpkg.com/prettier@2.8.3/standalone.js"],this._display=function(e){e._prettyCode=prettier.format(e._code,{parser:e._parser,plugins:prettierPlugins});var t=document.createElement("style"),i=document.createElement("template");t.innerHTML=`
